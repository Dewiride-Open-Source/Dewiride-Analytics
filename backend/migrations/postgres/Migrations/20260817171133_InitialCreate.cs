    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_visitor_key_salts", x => x.day);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_openiddict_authorizations_applications_application_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    retain_query_strings = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_openiddict_tokens_applications_application_id",
                        column: x => x.application_id,
                        principalTable: "openiddict_applications",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "fk_openiddict_tokens_authorizations_authorization_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_site_memberships", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "ix_site_memberships_user_id",
                table: "site_memberships",
                column: "user_id");

            migrationBuilder.CreateIndex(
                name: "ux_site_memberships_site_user",
                table: "site_memberships",
                columns: new[] { "site_id", "user_id" },
                unique: true);
