...
internal sealed class ClickHouseEventSink(IClickHouseClient client) : IEventSink
{
    ...
    [
        ...
        Text(source.Subdivision),
        Text(source.City),
        source.AutonomousSystem,
        Text(source.NetworkOwner),
        Text(source.ConfirmedOperator),
        Optional(source.ViewportWidth),
        Optional(source.ViewportHeight),
        Text(source.Language),
        Optional(source.TimezoneOffsetMinutes),
        StoredNames.DeviceClassNames[source.DeviceClass],
        Text(source.BrowserFamily),
        Text(source.OperatingSystem),
        StoredNames.Observed(source.DeclaredMobile),
        ...
        StoredNames.ControlKindNames[source.ActionControl],
        Text(source.ActionLabel),
        Text(source.ActionTarget),
        StoredNames.TargetKindNames[source.ActionTargetKind],
